...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white/5 dark:bg-slate-900/20 backdrop-blur-xl border-t border-slate-200/50 dark:border-white/5 text-slate-600 dark:text-slate-400 py-10 relative z-20 mt-10">
      <div className="container mx-auto px-6">
        ...
        {/* Bottom Section */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider">
          <p>
