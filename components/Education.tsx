        ...
        <div className="grid md:grid-cols-2 gap-16">
            <div>
                <ScrollReveal>
                    <div className="mb-10 flex items-center gap-4">
                        <div className="p-3 bg-primary-100/80 dark:bg-primary-900/50 text-primary-600 dark:text-primary-400 rounded-2xl">
                ...
                <div className="space-y-8">
                    {EDUCATION.map((edu, index) => (
                        ...
                        <div className="bg-white/20 dark:bg-slate-900/40 backdrop-blur-sm p-8 rounded-[2rem] border border-white/30 dark:border-white/10 shadow-lg hover:shadow-xl transition-all">
            ...
            <div>
                <ScrollReveal delay="delay-200">
                    <div className="mb-10 flex items-center gap-4">
                        <div className="p-3 bg-purple-100/80 dark:bg-purple-900/50 text-purple-600 dark:text-purple-400 rounded-2xl">
                ...
                <div className="space-y-4">
                  {CERTIFICATIONS.map((cert, index) => (
                    <ScrollReveal key={index} delay={`delay-[${(index * 100) + 200}ms]`}>
                        <div className="flex items-center justify-between p-6 rounded-[1.5rem] bg-white/20 dark:bg-slate-900/40 backdrop-blur-sm border border-white/30 dark:border-white/10 shadow-sm hover:shadow-lg hover:bg-white/40 dark:hover:bg-slate-800/40 transition-all duration-300 group">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-full bg-purple-50/50 dark:bg-purple-900/30 flex items-center justify-center text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform">
                            ...
                            <span className="text-xs font-bold text-slate-400 dark:text-slate-500 bg-white/40 dark:bg-white/10 px-3 py-1 rounded-full">
                                {cert.date}
                            </span>
                        </div>
                    </ScrollReveal>
