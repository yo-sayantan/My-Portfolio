            ...
            <div>
                ...
                <div className="space-y-8">
                    {EDUCATION.map((edu, index) => (
                        ...
                        <div className="bg-white/80 backdrop-blur-md p-8 rounded-[2rem] border border-white/60 shadow-lg hover:shadow-xl transition-all">
                ...
                <div className="space-y-4">
                  {CERTIFICATIONS.map((cert, index) => (
                    <ScrollReveal key={index} delay={`delay-[${(index * 100) + 200}ms]`}>
                        <div className="flex items-center justify-between p-6 rounded-[1.5rem] bg-white/80 backdrop-blur-md border border-white/60 shadow-sm hover:shadow-lg hover:bg-white transition-all duration-300 group">
